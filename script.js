$(document).ready(function() {
    ...
    loadingTl.staggerFrom(".loader h5 span", 0.5, {
        ease: Power4.easeIn,
        opacity: 0,
        y: -50
    }, 0.1)
    .to(".loader h5", 0.25, {y:-420})
    .to('.loader',0.5,{height:0})
    .from("#hero .hero-img", 0.4, {height:0})
    .staggerFrom("#hero h2 span", 0.5, {x:"-20px", opacity:0},0.1)
    .from("#hero h1", 0.5, {y: "100px", opacity:0})
    .staggerFrom(
        "#brand, nav .toggler, .social-media ul li a ion-icon", 0.5, {y:"-20px", opacity:0},0.2
    )
